...
const TIER_CONFIG: Record<string, { color: string; bg: string; label: string; icon: string }> = {
  high: { color: "text-emerald-500", bg: "border-emerald-500/30 bg-emerald-500/5", label: "High Confidence", icon: "✦" },
  medium: { color: "text-amber-500", bg: "border-amber-500/30 bg-amber-500/5", label: "Medium", icon: "◆" },
  low: { color: "text-muted-foreground", bg: "border-border bg-muted/20", label: "Low", icon: "○" },
};
